...
from train.train_AE import adapt_test
...
def main(args=args, configs=configs):
    ...
    for epoch in range(args.start_epoch, total_epochs):
        domain_weight, target_weight_init = train_AE(train_dloaders, models, classifiers, optimizers,
                            classifier_optimizers, epoch, writer, num_classes=num_classes,
                            domain_weight=domain_weight, target_weight_init=target_weight_init,
        ...
        adapt_test(args.target_domain, test_dloaders, models[0], classifiers[0],
                 num_classes=num_classes, top_5_accuracy=(num_classes > 10))
        print('\n')
